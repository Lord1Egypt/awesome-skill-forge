---
name: page-agent
description: "Embed alibaba/page-agent into your own web application — a pure-JavaScript in-page GUI agent that ships as a single script tag or npm package and lets end-users drive the UI with natural language. No Python, no headless browser, no extension required."
version: 1.0.0
author: community
license: MIT
