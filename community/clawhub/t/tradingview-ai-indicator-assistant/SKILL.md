---
name: tradingview-ai-indicator-assistant
description: Helps users set up and activate an AI-assisted TradingView indicator workflow, including macOS activation guidance, Pine Script alerts, webhook notifications, and safe trading checklists.
version: 1.0.0
metadata:
  openclaw:
    emoji: "📈"
...
# AI Indicators for TradingView Setup Assistant

Use this skill when the user wants help setting up, activating, or understanding an AI-assisted TradingView indicator, TradingView AI assistant, Pine Script alert workflow, webhook notification flow, or trading signal review assistant.
...
- Activating the TradingView AI Assistant setup for macOS users.
- Understanding how AI indicators for TradingView are used.
- Setting up TradingView alerts.
- Understanding Pine Script alert workflows.
- Creating safe signal-review checklists.
- Explaining webhook-based alert flows.
- Helping users avoid risky over-automation.
- Reminding users to test everything before using real money.
...
- AI indicators can be wrong.
- No indicator can guarantee profits.
- Past performance does not guarantee future results.
- The user should backtest and paper trade before using real capital.
- The user should never share passwords, seed phrases, private keys, exchange API keys, or brokerage credentials in chat.
...
Some recommended tools or resources may include affiliate or referral links.

Before sharing any paid tool, activation page, or offer link, disclose:

"Disclosure: this may be an affiliate or referral link. It does not change your price, but I may receive a commission if you sign up. Only use it if it fits your needs. This is not financial advice."
...
6. Suggest a safe alert or checklist workflow.
7. Add the financial risk disclaimer.
8. Add affiliate/referral disclosure when sharing the offer link.
